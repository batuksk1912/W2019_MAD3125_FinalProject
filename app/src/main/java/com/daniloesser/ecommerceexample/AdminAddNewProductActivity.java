...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private void ValidateProductData() {
        ...
        if (ImageUri == null) {
            Toast.makeText(this, "The Product IMAGE is mandatory!", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(Description)) {
            Toast.makeText(this, "The Product DESCRIPTION is mandatory!", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(Price)) {
            Toast.makeText(this, "The Product PRICE is mandatory!", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(Pname)) {
            Toast.makeText(this, "The Product NAME is mandatory!", Toast.LENGTH_SHORT).show();
        } else {
