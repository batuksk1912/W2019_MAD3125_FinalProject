...
import com.daniloesser.ecommerceexample.Model.Products;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addToCartButton.setOnClickListener((v -> {
            if (state.equals("Order Placed") || state.equals("Order Shipped")) {
                Toast.makeText(ProductDetailsActivity.this, "After completed your order process, you can purchase more products.", Toast.LENGTH_SHORT).show();
            } else {
                addingToCartList();
            }
        }));
        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    String formattedPrice = format.format(Float.parseFloat(products.getPrice()));
